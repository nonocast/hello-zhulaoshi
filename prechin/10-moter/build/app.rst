      ...
      000000 02 00 09         [24]  296 	ljmp	__sdcc_gsinit_startup
      000003 02 00 77         [24]  297 	ljmp	_int0
                                    298 ;--------------------------------------------------------
      ...
      000062 02 00 06         [24]  312 	ljmp	__sdcc_program_startup
                                    313 ;--------------------------------------------------------
                                    314 ; Home
                                    315 ;--------------------------------------------------------
                                    316 	.area HOME    (CODE)
      ...
      000006 02 00 65         [24]  319 	ljmp	_main
      ...
      000065 12 00 6D         [24]  342 	lcall	_init
                                    343 ;	src/app.c:15: while (true) {
      000068                        344 00102$:
                                    345 ;	src/app.c:16: loop();
      000068 12 00 76         [24]  346 	lcall	_loop
                                    347 ;	src/app.c:18: }
      00006B 80 FB            [24]  348 	sjmp	00102$
                                    349 ;------------------------------------------------------------
      ...
      00006D                        356 _init:
                                    ...
                                    358 ;	assignBit
      00006D D2 88            [12]  359 	setb	_IT0
                                    360 ;	src/app.c:22: EX0 = 1; // enable INT0 interrupt
                                    361 ;	assignBit
      00006F D2 A8            [12]  362 	setb	_EX0
                                    363 ;	src/app.c:23: EA = 1;  // open global interrupt switch
                                    364 ;	assignBit
      000071 D2 AF            [12]  365 	setb	_EA
                                    366 ;	src/app.c:24: P1_2 = 0;
                                    367 ;	assignBit
      000073 C2 92            [12]  368 	clr	_P1_2
                                    369 ;	src/app.c:25: }
      000075 22               [24]  370 	ret
                                    371 ;------------------------------------------------------------
      ...
      000076 22               [24]  379 	ret
                                    ...
                                    386 ;	-----------------------------------------
      000077                        387 _int0:
      000077 C0 20            [24]  388 	push	bits
      000079 C0 E0            [24]  389 	push	acc
      00007B C0 F0            [24]  390 	push	b
      00007D C0 82            [24]  391 	push	dpl
      00007F C0 83            [24]  392 	push	dph
      000081 C0 07            [24]  393 	push	(0+7)
      000083 C0 06            [24]  394 	push	(0+6)
      000085 C0 05            [24]  395 	push	(0+5)
      000087 C0 04            [24]  396 	push	(0+4)
      000089 C0 03            [24]  397 	push	(0+3)
      00008B C0 02            [24]  398 	push	(0+2)
      00008D C0 01            [24]  399 	push	(0+1)
      00008F C0 00            [24]  400 	push	(0+0)
      000091 C0 D0            [24]  401 	push	psw
      000093 75 D0 00         [24]  402 	mov	psw,#0x00
                                    403 ;	src/app.c:30: delay(10);
      000096 90 00 0A         [24]  404 	mov	dptr,#0x000a
      000099 12 00 BE         [24]  405 	lcall	_delay
                                    406 ;	src/app.c:31: if (P3_2 == 0) {
      00009C 20 B2 02         [24]  407 	jb	_P3_2,00103$
                                    408 ;	src/app.c:32: P1_2 = !P1_2;
      00009F B2 92            [12]  409 	cpl	_P1_2
      0000A1                        410 00103$:
                                    411 ;	src/app.c:34: }
      0000A1 D0 D0            [24]  412 	pop	psw
      0000A3 D0 00            [24]  413 	pop	(0+0)
      0000A5 D0 01            [24]  414 	pop	(0+1)
      0000A7 D0 02            [24]  415 	pop	(0+2)
      0000A9 D0 03            [24]  416 	pop	(0+3)
      0000AB D0 04            [24]  417 	pop	(0+4)
      0000AD D0 05            [24]  418 	pop	(0+5)
      0000AF D0 06            [24]  419 	pop	(0+6)
      0000B1 D0 07            [24]  420 	pop	(0+7)
      0000B3 D0 83            [24]  421 	pop	dph
      0000B5 D0 82            [24]  422 	pop	dpl
      0000B7 D0 F0            [24]  423 	pop	b
      0000B9 D0 E0            [24]  424 	pop	acc
      0000BB D0 20            [24]  425 	pop	bits
      0000BD 32               [24]  426 	reti
                                    427 ;------------------------------------------------------------
                                    ...
                                    435 ;	-----------------------------------------
      0000BE                        436 _delay:
      0000BE AE 82            [24]  437 	mov	r6,dpl
      0000C0 AF 83            [24]  438 	mov	r7,dph
                                    439 ;	src/app.c:37: while (i--)
      0000C2                        440 00101$:
      0000C2 8E 04            [24]  441 	mov	ar4,r6
      0000C4 8F 05            [24]  442 	mov	ar5,r7
      0000C6 1E               [12]  443 	dec	r6
      0000C7 BE FF 01         [24]  444 	cjne	r6,#0xff,00111$
      0000CA 1F               [12]  445 	dec	r7
      0000CB                        446 00111$:
      0000CB EC               [12]  447 	mov	a,r4
      0000CC 4D               [12]  448 	orl	a,r5
      0000CD 70 F3            [24]  449 	jnz	00101$
                                    450 ;	src/app.c:39: }
      0000CF 22               [24]  451 	ret
                                    452 	.area CSEG    (CODE)
                                    453 	.area CONST   (CODE)
                                    454 	.area XINIT   (CODE)
