      ...
      000003 02 00 7A         [24]  301 	ljmp	_main
                                    ...
                                    312 ;------------------------------------------------------------
                                    313 ;	src/app.c:6: void delay(unsigned int i) {
                                    314 ;	-----------------------------------------
                                    315 ;	 function delay
                                    316 ;	-----------------------------------------
      000062                        317 _delay:
      ...
      000064 AF 83            [24]  327 	mov	r7,dph
                                    328 ;	src/app.c:8: for (i; i > 0; i--)
      000066                        329 00106$:
      000066 EE               [12]  330 	mov	a,r6
      000067 4F               [12]  331 	orl	a,r7
      000068 60 0F            [24]  332 	jz	00108$
                                    333 ;	src/app.c:9: for (j = 100; j > 0; j--)
      00006A 7D 64            [12]  334 	mov	r5,#0x64
      00006C                        335 00104$:
      ...
      000079 22               [24]  349 	ret
                                    ...
                                    352 ;------------------------------------------------------------
                                    353 ;i                         Allocated to registers r6 r7 
                                    354 ;------------------------------------------------------------
                                    355 ;	src/app.c:13: void main() {
                                    356 ;	-----------------------------------------
                                    357 ;	 function main
                                    358 ;	-----------------------------------------
      00007A                        359 _main:
                                    360 ;	src/app.c:16: for (i = 0; i < 8; ++i) {
      00007A                        361 00109$:
      00007A 7E 00            [12]  362 	mov	r6,#0x00
      00007C 7F 00            [12]  363 	mov	r7,#0x00
      00007E                        364 00105$:
                                    365 ;	src/app.c:17: P0 = ~(0x01 << i);
      00007E 8E 05            [24]  366 	mov	ar5,r6
      000080 8D F0            [24]  367 	mov	b,r5
      000082 05 F0            [12]  368 	inc	b
      000084 74 01            [12]  369 	mov	a,#0x01
      000086 80 02            [24]  370 	sjmp	00124$
      000088                        371 00122$:
      000088 25 E0            [12]  372 	add	a,acc
      00008A                        373 00124$:
      00008A D5 F0 FB         [24]  374 	djnz	b,00122$
      00008D F4               [12]  375 	cpl	a
      00008E F5 80            [12]  376 	mov	_P0,a
                                    377 ;	src/app.c:18: delay(1000);
      000090 90 03 E8         [24]  378 	mov	dptr,#0x03e8
      000093 C0 07            [24]  379 	push	ar7
      000095 C0 06            [24]  380 	push	ar6
      000097 12 00 62         [24]  381 	lcall	_delay
      00009A D0 06            [24]  382 	pop	ar6
      00009C D0 07            [24]  383 	pop	ar7
                                    384 ;	src/app.c:16: for (i = 0; i < 8; ++i) {
      00009E 0E               [12]  385 	inc	r6
      00009F BE 00 01         [24]  386 	cjne	r6,#0x00,00125$
      0000A2 0F               [12]  387 	inc	r7
      0000A3                        388 00125$:
      0000A3 C3               [12]  389 	clr	c
      0000A4 EE               [12]  390 	mov	a,r6
      0000A5 94 08            [12]  391 	subb	a,#0x08
      0000A7 EF               [12]  392 	mov	a,r7
      0000A8 64 80            [12]  393 	xrl	a,#0x80
      0000AA 94 80            [12]  394 	subb	a,#0x80
      0000AC 40 D0            [24]  395 	jc	00105$
                                    396 ;	src/app.c:21: }
      0000AE 80 CA            [24]  397 	sjmp	00109$
                                    398 	.area CSEG    (CODE)
                                    399 	.area CONST   (CODE)
                                    400 	.area XINIT   (CODE)
